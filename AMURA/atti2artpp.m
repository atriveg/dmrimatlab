function rtpp = atti2artpp( atti, gi, bi, varargin )
% function rtpp = atti2artpp( atti, gi, bi, 'option1', value1, ... )
%
%   Computes the (apparent) Return To Plane Probability according to a 
...
%   Outputs:
%
%      rtpp: MxNxP double array with the computed RTPP.
%
...
rtpp = atti2amura( atti, gi, bi, ...
    'type', 'rtpp', 'u0', u0, 'mask', opt.mask, ...
