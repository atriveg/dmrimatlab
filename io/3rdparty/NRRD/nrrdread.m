...
%%%%%%%%%%%%%%%%%%%%%% CODE PATCHED FROM THE ORIGINAL %%%%%%%%%%%%%%%%%%%%%
% To be consistent with the Nifti toolbox, and also with
% the rest of the functions of the whole toolbox, we will
% use always zero-based indexing.
% OLD CODE:
...
%%%%%%%%%%%%%%%%%%% END OF CODE PATCHED FROM THE ORIGINAL %%%%%%%%%%%%%%%%%
